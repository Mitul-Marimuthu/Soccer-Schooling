...
// andrew, mitul
// Class with main
public class SoccerSchooling3
{
	public SoccerSchooling3()
	{
	}
	
	public static void main(String[] args)
	{
		SoccerSchooling3 game = new SoccerSchooling3();
		game.run();
	}
...
class Options extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evt)
	{
		if (counter >= 4)
		{
			...
			ap5.getMainPanel().setVars(ap5.getOptionsPanel().getDifficulty());
