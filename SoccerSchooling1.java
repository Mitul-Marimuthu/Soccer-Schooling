...
// andrew, mitul
// Class with main
public class SoccerSchooling1
{
	public SoccerSchooling1()
	{
	}
	
	public static void main(String[] args)
	{
		SoccerSchooling1 game = new SoccerSchooling1();
		game.run();
	}
...
class Options extends JPanel implements ActionListener
{
	...
	private AddCards ap5;
	private CardLayout cards5;
	private ButtonGroup modeGroup, difficultyGroup, inputMethodGroup;
...
{ 
	...
	public InstructionsPanel()
	{
		...
		instructions.setText("\t\t         Welcome to Soccer Schooling!\n\nIn this math "
			...
			+ "5 seconds. However, we do want you to learn from you mistakes, so for every " 
...
class MainPanel extends JPanel implements ActionListener
{
	...
	private int score, fontSize, time; //player stats
...
class Animation extends JPanel implements ActionListener
{
	...
	private int soccerX, soccerY, goalieX, goalieY, goalWidth, goalHeight;
	private int soccerTravelX, soccerTravelY, goalieTravelX, goalieTravelY;
	private Timer animationTimer;
	private int timePassed, picture, correctCorner;
	private MainPanel mp4; 
...
class SetButtonLayout extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		System.out.println(choice.indexOf(search));
...
// andrew
class SetLabelLayout extends JPanel
{
...
{
	private AddCards ac7;
	private CardLayout cards7;
...
class GenerateQuestions
{
	...
	private TrigQuestions tq;
	private AddCards ac8;
	...
	public void getQuestion()
	{
		if (ac8.getOptionsPanel().getMode().equals("Trigonometry") && 
			ac8.getOptionsPanel().getDifficulty().equals("Simple"))
		{
	...
	public void setAnswerOptions(double answerIn, int indexIn, String questionIn2)
	{
		...
		System.out.println(questionIn2);
...
class TrigQuestions
{
	private String[] trigFunctions;
	private double[] angleMeasures;
	private String question;
	private double angle;
	private GenerateQuestions gq2;
